classdef EmotivEEG < handle
    ...
    %EmotivEEG 
    %----------
    %queries the EDK library in order to receive data from the
    %Emotiv EEG headset
    %
    %% Usage;
    ...
    % a.Record(10)    
    % % To load recorded data from file into /c data variable
    % % (NOTE if you have a timer on this will be overwritten)
    ...
    properties
        ...
        timerPeriod = 0.35; %seconds *MUST BE LESS THAN acquisitionSeconds. Also used for updating the record data
        plotTimerPeriod = 0.5;
        fig_h;
        showDebug = false;
    end
    ...
    properties (SetAccess = protected)
        ...
        % CognitivSuite enums
        EE_CognitivTrainingControl_enum = struct('COG_NONE',    0, ...
                                                 'COG_START',   1, ...
                                                 'COG_ACCEPT',  2, ...
                                                 'COG_REJECT',  3, ...
                                                 'COG_ERASE',   4, ...
        ...
        EE_ExpressivAlgo_enum = struct('EXP_NEUTRAL',       1,      ...
                                       'EXP_BLINK',         2,      ...
                                       'EXP_WINK_LEFT',     4,      ...
                                       'EXP_WINK_RIGHT',    8,      ...
                                       'EXP_HORIEYE',       16,     ...
        ...
        EE_ExpressivTrainingControl_enum = struct('EXP_NONE',   0, ...
                                                  'EXP_START',  1, ...
                                                  'EXP_ACCEPT', 2, ...
                                                  'EXP_REJECT', 3, ...
                                                  'EXP_ERASE',  4, ...
        ...
        EE_CognitivEvent_enum = struct('EE_CognitivNoEvent',            0, ...
        ...
        EE_EmotivSuite_enum=struct('EE_EXPRESSIV',  0, ...
                                   'EE_AFFECTIV',   1, ...
                                   'EE_COGNITIV',   2);

        EE_ExpressivEvent_enum=struct('EE_ExpressivNoEvent',            0, ...
        ...
        EE_CognitivAction_enum=struct('COG_NEUTRAL',            1,      ...
                                      'COG_PUSH',               2,      ...
                                      'COG_PULL',               4,      ...
                                      'COG_LIFT',               8,      ...
                                      'COG_DROP',               16,     ...
        ...
        EE_InputChannels_enum=struct('EE_CHAN_CMS',     0, ...
                                     'EE_CHAN_DRL',     1, ...
                                     'EE_CHAN_FP1',     2, ...
                                     'EE_CHAN_AF3',     3, ...
                                     'EE_CHAN_F7',      4, ...
        ...
        EE_ExpressivSignature_enum=struct('EXP_SIG_UNIVERSAL',  0, ...
                                          'EXP_SIG_TRAINED',    1);

        EE_Event_enum=struct('EE_UnknownEvent',         0,  ...
                             'EE_EmulatorError',        1,  ...
                             'EE_ReservedEvent',        2,  ...
                             'EE_UserAdded',            16, ...
                             'EE_UserRemoved',          32, ...
    ...
    properties (Access = protected)
        % holds the data while it is being read from the library
        tempData = []
    end
    ...
    methods
        function self = EmotivEEG(libraryPath)
            ...
            calllib('edk','EE_DataSetBufferSizeInSec',self.acquisitionSeconds);
            % Create an events engine
            self.eEvent = calllib('edk','EE_EmoEngineEventCreate');

            self.dataRowCount = self.acquisitionSeconds * self.sampFreq;
            self.data = zeros(self.dataRowCount,self.channelCount);
            % required to work on the data variable but still 
